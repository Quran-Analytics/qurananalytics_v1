...
tf_plotter(df = surah_wordsESI, 
           ...
           title_label = "Term Frequency in Short Length Surah (Saheeh)",
           x_lim = 0.10)
```
...
tf_plotter(df = surah_wordsEYA, 
           surah_group = last6_surahs, 
           title_label = "Term Frequency in Short Length Surah (Yusuf Ali)",
           x_lim = 0.10)
```
...
tf_plotter(df = surah_wordsMAB, 
           surah_group = last6_surahs, 
           title_label = "Term Frequency in Short Length Surah (Malay)",
           x_lim = 0.10)
```
...
tf_plotter(df = surah_wordsESI, 
           ...
           title_label = "Term Frequency in Medium Length Surah (Saheeh)",
           x_lim = 0.01)
```
...
tf_plotter(df = surah_wordsEYA, 
           surah_group = hamim_surahs, 
           title_label = "Term Frequency in Medium Length Surah (Yusuf Ali)",
           x_lim = 0.01)
```
...
tf_plotter(df = surah_wordsMAB, 
           surah_group = hamim_surahs, 
           title_label = "Term Frequency in Medium Length Surah (Malay)",
           x_lim = 0.01)
```
...
tf_plotter(df = surah_wordsESI, 
           ...
           title_label = "Term Frequency in Long Length Surah (Saheeh)",
           x_lim = 0.002)
```
...
tf_plotter(df = surah_wordsEYA, 
           surah_group = long_surahs, 
           title_label = "Term Frequency in Long Length Surah (Yusuf Ali)",
           x_lim = 0.002)
```
...
tf_plotter(df = surah_wordsMAB, 
           surah_group = long_surahs, 
           title_label = "Term Frequency in Long Length Surah (Malay)",
           x_lim = 0.002)
```
...
p1 = tfidf_plotter(ESI_tf_idf,"Saheeh")
p2 = tfidf_plotter(EYA_tf_idf,"Yusuf Ali")
p3 = tfidf_plotter(MAB_tf_idf,"Malay")
...
tfidf_plotter(df = surah_wordsESI, 
           surah_group = last6_surahs, 
           title_label = "TF-IDF for Short Surah (Saheeh)",
           top_n_words = 7)
```
...
tfidf_plotter(df = surah_wordsEYA, 
           surah_group = last6_surahs, 
           title_label = "TF-IDF for Short Surah (Yusuf Ali)",
           top_n_words = 7)
```
...
tfidf_plotter(df = surah_wordsMAB, 
           surah_group = last6_surahs, 
           title_label = "TF-IDF for Short Surah (Malay)",
           top_n_words = 7)
```
...
tfidf_plotter(df = surah_wordsESI, 
           surah_group = hamim_surahs, 
           title_label = "TF-IDF for Medium Surah (Saheeh)",
           top_n_words = 7)
```
...
tfidf_plotter(df = surah_wordsEYA, 
           surah_group = hamim_surahs, 
           title_label = "TF-IDF for Medium Surah (Yusuf Ali)",
           top_n_words = 7)
```
...
tfidf_plotter(df = surah_wordsMAB, 
           surah_group = hamim_surahs, 
           title_label = "TF-IDF for Medium Surah (Malay)",
           top_n_words = 7)
```
...
tfidf_plotter(df = surah_wordsESI, 
           surah_group = last6_surahs, 
           title_label = "TF-IDF for Long Surah (Saheeh)",
           top_n_words = 7)
```
...
tfidf_plotter(df = surah_wordsEYA, 
           surah_group = last6_surahs, 
           title_label = "TF-IDF for Long Surah (Yusuf Ali)",
           top_n_words = 7)
```
...
tfidf_plotter(df = surah_wordsMAB, 
           surah_group = last6_surahs, 
           title_label = "TF-IDF for Long Surah (Malay)",
           top_n_words = 7)
```
...
tf_combined %>% ggplot(aes(x = log(term_frequency))) + 
    ...
    labs(x = "Log of Term Frequency",y = 'Density') +
    facet_wrap(~transl)+
