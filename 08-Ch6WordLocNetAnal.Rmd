...
``` {r ch6fig601, fig.align="center", fig.height=4, fig.width=8, echo=T, warning=F, fig.cap="First plot of tutorial word network"}
...
NMtall %>% arrange(desc(Value)) %>%
     ...
     geom_point(size = 2) + 
     scale_color_manual(values = c("degree_in" = 'blue',"degree_out" = 'red'))+
...
NMtall %>% arrange(desc(Value)) %>%
     ...
     geom_point(size = 2) +
     scale_color_manual(values = c("#00A36C","red","blue"))+
