...
grid::grid.raster(png::readPNG("images/ch8aqa.png"))
...
```{r ch8fig802, fig.align="center",fig.height=5,fig.width=7, echo=T,warning=F, fig.cap="Top terms with LDA methods for Surah Al-Kahf"}
library(tidytext)
...
```{r ch8fig804, results="hide",fig.align="center",fig.height=5,fig.width=7, echo=T,warning=F, fig.cap="STM topic shares for Surah Al-Kahf"}
...
```{r ch8fig817,fig.align="center",fig.height=5,fig.width=7, echo=F,warning=F, fig.cap="Topics in dimensions for Surah Al-Kahf using LSA and GloVe"}
