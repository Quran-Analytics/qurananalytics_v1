...
\NormalTok{EQT\_total\_toks\_melt }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
                            ...
                            \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Surah number"}\NormalTok{, }
                                 ...
                                 \AttributeTok{title =} \StringTok{"Percentage of Unique Words in Surah"}\NormalTok{) }\SpecialCharTok{+}
...
\NormalTok{tfidf\_plotter }\OtherTok{=} \ControlFlowTok{function}\NormalTok{(df\_plot,title\_label,color)\{}
                ...
                \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =}\NormalTok{ title\_label, }\AttributeTok{x =} \StringTok{"n"}\NormalTok{, }\AttributeTok{y =} \StringTok{"tf\_idf"}\NormalTok{)}\SpecialCharTok{+}
                \FunctionTok{theme}\NormalTok{(}\AttributeTok{panel.border =} \FunctionTok{element\_rect}\NormalTok{(}\AttributeTok{colour =} \StringTok{"black"}\NormalTok{, }\AttributeTok{fill=}\ConstantTok{NA}\NormalTok{),}
...
\NormalTok{dfd }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ strength, }\AttributeTok{y =}\NormalTok{ degree)) }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{() }\SpecialCharTok{+}
        ...
        \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Word Co{-}occurrences Network"}\NormalTok{,}
             \AttributeTok{y =} \StringTok{"Degree"}\NormalTok{,}\AttributeTok{x =} \StringTok{"Strength"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{kahf\_1 }\OtherTok{=}\NormalTok{ kahf }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pull}\NormalTok{(text) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{str\_flatten}\NormalTok{()}
\NormalTok{maryam\_1 }\OtherTok{=}\NormalTok{ maryam }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{pull}\NormalTok{(text) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{str\_flatten}\NormalTok{()}
\NormalTok{kahf\_maryam }\OtherTok{=}\NormalTok{ kahf\_maryam }\OtherTok{=} \FunctionTok{rbind}\NormalTok{(kahf\_1,maryam\_1)}

\NormalTok{corp }\OtherTok{=} \FunctionTok{corpus}\NormalTok{(kahf\_maryam,}
              \AttributeTok{docvarsz =} \FunctionTok{c}\NormalTok{(}\StringTok{"kahf"}\NormalTok{,}\StringTok{"maryam"}\NormalTok{))}
\FunctionTok{names}\NormalTok{(corp) }\OtherTok{=} \FunctionTok{c}\NormalTok{(}\StringTok{"kahf"}\NormalTok{,}\StringTok{"maryam"}\NormalTok{)}

\NormalTok{dfmat2 }\OtherTok{\textless{}{-}} \FunctionTok{dfm}\NormalTok{(corp,}
              \CommentTok{\# groups = "surah",}
              \AttributeTok{remove =}\NormalTok{ stop\_words}\SpecialCharTok{$}\NormalTok{word,}
              \AttributeTok{remove\_punct =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{tstat2 }\OtherTok{\textless{}{-}} \FunctionTok{textstat\_keyness}\NormalTok{(dfmat2, }\AttributeTok{target =} \StringTok{"kahf"}\NormalTok{, }\AttributeTok{measure =} \StringTok{"lr"}\NormalTok{)}
\FunctionTok{textplot\_keyness}\NormalTok{(tstat2, }\AttributeTok{color =} \FunctionTok{c}\NormalTok{(}\StringTok{"steelblue"}\NormalTok{, }\StringTok{"tomato"}\NormalTok{), }\AttributeTok{n =} \DecValTok{20}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Keyness For Surah Maryam and Surah Al{-}Kahf"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{p1 }\OtherTok{=} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(kahf\_lexdiv), }
                           ...
                           \AttributeTok{show.legend =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylim}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{5}\NormalTok{)}\SpecialCharTok{+}
                \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Verse"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Lexical Diversity Score"}\NormalTok{,}\AttributeTok{title =} \StringTok{"Surah Al{-}Kahf"}\NormalTok{)}
\NormalTok{p2 }\OtherTok{=} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\SpecialCharTok{:}\FunctionTok{nrow}\NormalTok{(maryam\_lexdiv), }
                               ...
                               \AttributeTok{show.legend =} \ConstantTok{FALSE}\NormalTok{) }\SpecialCharTok{+} \FunctionTok{ylim}\NormalTok{(}\DecValTok{0}\NormalTok{,}\DecValTok{5}\NormalTok{)}\SpecialCharTok{+}
                \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Verse"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Lexical Diversity Score"}\NormalTok{,}\AttributeTok{title =} \StringTok{"Surah Maryam"}\NormalTok{)}
\NormalTok{cowplot}\SpecialCharTok{::}\FunctionTok{plot\_grid}\NormalTok{(p1,p2, }\AttributeTok{nrow =} \DecValTok{1}\NormalTok{,}\AttributeTok{align =} \StringTok{"v"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(tstcor\_kahf}\SpecialCharTok{$}\NormalTok{correlation)), }\AttributeTok{y =}\NormalTok{ tstcor\_kahf}\SpecialCharTok{$}\NormalTok{correlation), }\AttributeTok{color =} \StringTok{"red"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(tstcos\_kahf}\SpecialCharTok{$}\NormalTok{cosine)), }\AttributeTok{y =}\NormalTok{ tstcos\_kahf}\SpecialCharTok{$}\NormalTok{cosine), }\AttributeTok{color =} \StringTok{"blue"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \FunctionTok{c}\NormalTok{(}\DecValTok{1}\SpecialCharTok{:}\FunctionTok{length}\NormalTok{(tstjac\_kahf}\SpecialCharTok{$}\NormalTok{jaccard)), }\AttributeTok{y =}\NormalTok{ tstjac\_kahf}\SpecialCharTok{$}\NormalTok{jaccard), }\AttributeTok{color =} \StringTok{"\#3B9D47"}\NormalTok{) }\SpecialCharTok{+}
...
\FunctionTok{ggraph}\NormalTok{(igph\_kahfcos, }\AttributeTok{layout =} \StringTok{"kk"}\NormalTok{) }\SpecialCharTok{+}
  ...
  \FunctionTok{geom\_node\_text}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{label =}\NormalTok{ name), }\AttributeTok{col =} \StringTok{"black"}\NormalTok{, }\AttributeTok{size =} \DecValTok{4}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Verses with High Similarity for Surah Al{-}Kahf"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{(}
              ...
              \AttributeTok{color =} \StringTok{"\#54B660"}\NormalTok{) }\SpecialCharTok{+}
              \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Edges"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Distance Score"}\NormalTok{,}
                   \AttributeTok{title =} \StringTok{"Verses Distance for Surah Al{-}Kahf"}\NormalTok{,}
                   \AttributeTok{subtitle =} \StringTok{"Using Manhattan Measures"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{fig901a }\OtherTok{=}\NormalTok{ kg\_degree }\SpecialCharTok{\%\textgreater{}\%}  \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} 
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title=}\StringTok{"A: Degree of verses"}\NormalTok{,}\AttributeTok{x =} \StringTok{"Verse"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Degree"}\NormalTok{)}
...
\NormalTok{fig902 }\OtherTok{=} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_col}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =} \DecValTok{1}\SpecialCharTok{:}\DecValTok{35}\NormalTok{,}\AttributeTok{y=}\NormalTok{kg\_dist\_table}\SpecialCharTok{$}\NormalTok{res), }\AttributeTok{fill =} \StringTok{"steelblue"}\NormalTok{,}\AttributeTok{color =} \StringTok{\textquotesingle{}black\textquotesingle{}}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Distance"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Frequency"}\NormalTok{)}\SpecialCharTok{+}
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{title =} \StringTok{"Katheer Graph Path Lengths Distributions"}\NormalTok{)}\SpecialCharTok{+}
...
\CommentTok{\# kgsp = shortest\_paths(kg,from = "6:25", to = V(kg), mode = "in")}
\NormalTok{fig903a }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"x"} \OtherTok{=} \DecValTok{1}\SpecialCharTok{:}\DecValTok{6236}\NormalTok{, }\StringTok{"y"} \OtherTok{=}\NormalTok{ kgd[,}\StringTok{"6:25"}\NormalTok{]) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_point}\NormalTok{(}\FunctionTok{aes}\NormalTok{(x,y), }\AttributeTok{color=}\StringTok{"steelblue"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Verses"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Distance"}\NormalTok{)}

\NormalTok{fig903b }\OtherTok{=} \FunctionTok{data.frame}\NormalTok{(}\StringTok{"x"} \OtherTok{=} \DecValTok{1}\SpecialCharTok{:}\DecValTok{6236}\NormalTok{, }\StringTok{"y"} \OtherTok{=}\NormalTok{ kgd[,}\StringTok{"6:25"}\NormalTok{]) }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{() }\SpecialCharTok{+} \FunctionTok{geom\_density}\NormalTok{(}\FunctionTok{aes}\NormalTok{(y), }\AttributeTok{color=}\StringTok{"steelblue"}\NormalTok{) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Verses"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Distance"}\NormalTok{)  }

\DocumentationTok{\#\# fig903: Centrality measures of verses in Ibnu Katheer: Prestige vs Betweeness}
\NormalTok{fig903c }\OtherTok{=}\NormalTok{ ik\_gephi }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{(}\FunctionTok{aes}\NormalTok{(}\AttributeTok{x =}\NormalTok{ eigencentrality, }\AttributeTok{y =}\NormalTok{ betweenesscentrality)) }\SpecialCharTok{+} 
  ...
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Prestige Centrality"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Betweenness Centrality"}\NormalTok{,}
       \AttributeTok{title =} \StringTok{"Centrality Measures of verses in Ibnu Katheer"}\NormalTok{,}
       \AttributeTok{subtitle =} \StringTok{"Prestige vs Betweeness"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}
...
\NormalTok{fig904 }\OtherTok{=}\NormalTok{ ik\_gephi }\SpecialCharTok{\%\textgreater{}\%} \FunctionTok{ggplot}\NormalTok{( }\FunctionTok{aes}\NormalTok{(}\AttributeTok{x=}\NormalTok{pageranks, }\AttributeTok{y=}\NormalTok{Authority)) }\SpecialCharTok{+}
  ...
  \FunctionTok{geom\_text}\NormalTok{( }\FunctionTok{aes}\NormalTok{(}\AttributeTok{label=}\NormalTok{ik\_gephi}\SpecialCharTok{$}\NormalTok{Id), }\AttributeTok{size =} \DecValTok{3}\NormalTok{, }\AttributeTok{check\_overlap =}\NormalTok{ T) }\SpecialCharTok{+}
  \FunctionTok{labs}\NormalTok{(}\AttributeTok{x =} \StringTok{"Pageranks"}\NormalTok{, }\AttributeTok{y =} \StringTok{"Authority"}\NormalTok{,}
       \AttributeTok{title =} \StringTok{"Centrality Measures of verses in Ibnu Katheer"}\NormalTok{,}
       \AttributeTok{subtitle =} \StringTok{"Pageranks vs Authority"}\NormalTok{)}\SpecialCharTok{+}
  \FunctionTok{theme\_bw}\NormalTok{()}
